...
def GetPhenotype_list(NativeTable,species,f_all,path_to_pr,output):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-table', '--table', type=str, required=True,
                        help='phenotype table generated by ResFinder.')
    ...
    GetPhenotype_list(parsedArgs.table,parsedArgs.species,parsedArgs.f_all,parsedArgs.work_path,parsedArgs.output)
